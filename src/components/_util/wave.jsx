...
export default {
    ...
    methods: {
        ...
        onClick(node, waveColor) {
            ...
            // console.log('----styleForPesudo', styleForPesudo)
        ...
        onTransitionStart(e) {
            ...
            const node = this.$el;
            // console.log('----t3', node, e.target)
            if (!e || e.target !== node) {
                return;
            }

            // console.log('---time3', +new Date, this.animationStart);
    ...
    render() {
        console.log('-------this.$slots.default', this.$slots.default, this.$slots)
